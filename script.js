...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            linkStore: "Julius' Store",
            linkStoreDesc: "Get: Digital Skills, Tools, Classes & More",
            ...
            aboutNyotaDesc: "It’s a simple storefront for your video courses, podcasts, e-books, templates and anything digital with zero subscription costs. Just radical simplicity: your audience pays via M-Pesa or Card. Want a demo?",
        ...
        sw: {
            ...
            linkStore: "Julius' Store",
            linkStoreDesc: "Jipatie: Ujuzi wa Kidigitali, Vifaa, Fremu na vinginevyo",
            linkKidarasa: "Kidarasa",
            ...
            aboutIntro: "Mimi ni Julius Moshiro. Kupitia Atana Ventures, naunganisha ukuaji wa kidigitali na uhalisia wa maisha. Niwe nyuma ya kamera, nakimbia mbio ndefu, au naandika kodi, lengo langu ni kutengeneza zana zinazorudisha muda na uhuru kwa wabunifu na wafanyabiashara.",
            aboutToolkitTitle: "Zana Zangu za Open-Source",
            aboutNyotaTitle: "Nyota ✨",
            aboutNyotaDesc: "Ni duka lako binafsi la kidigitali kwa ajili ya kozi za video, podcast, vitabu (e-books), na 'templates'. Inawezesha wateja wako kukulipa kwa M-Pesa, AirtelMoney, Mixx au Kadi na wanapata bidhaa zao papo hapo. Kwa namba ya simu pekee. Je, unahitaji maelezo zaidi?",
            aboutStokiTitle: "Stoki 📦",
            ...
            aboutProductionTitle: "Picha, Video na uzalishaji wa Maudhui ya Kidigitali",
            aboutProductionDesc: "Ninasaidia mashirika kusimulisha hadithi zao na kurekodi mafanikio yao kote Afrika. Kwa miaka kadhaa, nimefanya kazi na mashirika makubwa ikiwa ni pamoja na Umoja wa Ulaya (EU), 'African Wild Life Foundation(AWF)', 'World Bank', na 'Bill & Melinda Gates Foundation', nikiumba maudhui yanayowasilisha nia zao kwa uhai.",
